...
var _chunk2VCLI5YNjs = require('./chunk-2VCLI5YN.js');
...
// src/core/context.ts
var import_utils5 = _chunkBNJB64XRjs.__toModule.call(void 0, _chunk2VCLI5YNjs.require_dist.call(void 0, ));
var _path = require('path');
var _debug = require('debug'); var _debug2 = _interopRequireDefault(_debug);

// src/core/options.ts
var import_utils = _chunkBNJB64XRjs.__toModule.call(void 0, _chunk2VCLI5YNjs.require_dist.call(void 0, ));
...
function resolveOptions(options, root) {
  ...
  resolved.resolvers.push(...resolved.libraries.map((lib) => _chunk2VCLI5YNjs.LibraryResolver.call(void 0, lib)));
...
function getVueVersion() {
  var _a;
  try {
    const vue = _chunkBNJB64XRjs.__require.call(void 0, "vue");
...
var import_utils2 = _chunkBNJB64XRjs.__toModule.call(void 0, _chunk2VCLI5YNjs.require_dist.call(void 0, ));
...
async function generateDeclaration(ctx, root, filepath) {
  const imports = Object.fromEntries(Object.values(_chunkBNJB64XRjs.__spreadValues.call(void 0, _chunkBNJB64XRjs.__spreadValues.call(void 0, {}, ctx.componentNameMap), ctx.componentCustomMap)).map(({ path, name, importName }) => {
    if (!name)
      return void 0;
  ...
  const lines = Object.entries(_chunkBNJB64XRjs.__spreadValues.call(void 0, _chunkBNJB64XRjs.__spreadValues.call(void 0, {}, originalImports), imports)).sort((a, b) => a[0].localeCompare(b[0])).map(([name, v]) => {
    if (!/^\w+$/.test(name))
      name = `'${name}'`;
    return `${name}: ${v}`;
  });
  ...
  return (code, id, path, query) => {
    ...
    for (const match of code.matchAll(/_c\([\s\n\t]*['"](.+?)["']([,)])/g)) {
      ...
      if (match.index != null && matchedName && !matchedName.startsWith("_")) {
        ...
        debug2(`| ${matchedName}`);
        const name = _chunk2VCLI5YNjs.pascalCase.call(void 0, matchedName);
        ...
        if (component) {
          ...
          head.push(_chunk2VCLI5YNjs.stringifyComponentImport.call(void 0, _chunkBNJB64XRjs.__spreadProps.call(void 0, _chunkBNJB64XRjs.__spreadValues.call(void 0, {}, component), { name: var_name }), ctx));
          no += 1;
    ...
    if (!head.length)
      return null;
    s.prepend(`${_chunk2VCLI5YNjs.DISABLE_COMMENT}${head.join(";")};`);
...
var Context = class {
  ...
  transform(code, id) {
    const { path, query } = _chunk2VCLI5YNjs.parseId.call(void 0, id);
  ...
  setupWather(watcher) {
    ...
    watcher.on("unlink", (path) => {
      if (!_chunk2VCLI5YNjs.matchGlobs.call(void 0, path, globs))
        return;
  ...
  onUpdate(path) {
    ...
    const name = _chunk2VCLI5YNjs.pascalCase.call(void 0, _chunk2VCLI5YNjs.getNameFromFilePath.call(void 0, path, this.options));
    ...
    for (const resolver of this.options.resolvers) {
      ...
      if (result) {
        if (typeof result === "string") {
          ...
          info = _chunkBNJB64XRjs.__spreadValues.call(void 0, {
            name
          }, result);
          this.addCustomComponents(info);
          return info;
  ...
  normalizePath(path) {
    var _a, _b, _c;
    return _chunk2VCLI5YNjs.resolveAlias.call(void 0, path, ((_b = (_a = this.viteConfig) == null ? void 0 : _a.resolve) == null ? void 0 : _b.alias) || ((_c = this.viteConfig) == null ? void 0 : _c.alias) || []);
  }
  relative(path) {
...
var unplugin_default = _unplugin.createUnplugin.call(void 0, (options = {}) => {
  ...
  return {
    ...
    async transform(code, id) {
      if (!_chunk2VCLI5YNjs.shouldTransform.call(void 0, code))
        return null;
      try {
