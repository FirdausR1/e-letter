...
var require_dist = _chunkBNJB64XRjs.__commonJS.call(void 0, {
...
// src/core/utils.ts
var import_utils = _chunkBNJB64XRjs.__toModule.call(void 0, require_dist());
...
function getPkgVersion(pkgName, defaultVersion) {
  try {
    return _chunkBNJB64XRjs.__require.call(void 0, `${pkgName}/package.json`).version;
  } catch (err) {
    console.error(err);
