...
var _chunkCMXOIFMOjs = require('./chunk-CMXOIFMO.js');
...
function getVueVersion() {
  var _a;
  try {
    const vue = _chunkGMAU6NZDjs.__require.call(void 0, "vue");
...
var unplugin = _unplugin.createUnplugin.call(void 0, (options = {}) => {
  ...
  return {
    ...
    enforce: "pre",
    resolveId(id) {
      if (_chunkCMXOIFMOjs.isIconPath.call(void 0, id)) {
        const res = _chunkCMXOIFMOjs.normalizeIconPath.call(void 0, id).replace(/\.\w+$/i, "").replace(/^\//, "");
    ...
    async load(id) {
      if (_chunkCMXOIFMOjs.isIconPath.call(void 0, id)) {
        const code = await _chunkCMXOIFMOjs.generateComponentFromPath.call(void 0, id, resolved) || null;
        if (code)
